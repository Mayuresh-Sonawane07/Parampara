    ...
    try:
        ...
        hotspots = [
            models.ARHotspot(
                ...
                name='The Tarpa Spiral Dance',
                x=50.0,
                y=52.0,
                content='Men and women entwine arms, dancing in an ever-widening spiral around the central player of the Tarpa wind instrument.',
                cultural_context='The spiral dancers move counter-clockwise, symbolizing the cyclic rhythm of nature, seasonal transitions, and community unity without beginning or end.',
                regional_perspective='Documented by INTACH Dahanu Chapter as the most celebrated communal dance among the Palghar Warli community.',
                source_id=s7.id,
                audio_url=None,
            ...
            models.ARHotspot(
                ar_experience_id=ar_warli.id,
                name='Mother Goddess Palaghata & Sacred Chauk',
                x=28.0,
                y=25.0,
                content='Inside the sacred square (Lagna chauk) sits Palaghata, the goddess of corn, trees, and fertility.',
                cultural_context='Painted primarily by married women (Suhasinis) during wedding rites (Lagna) to invoke blessings for harvest abundance and family prosperity.',
                regional_perspective='The square enclosure represents sacred space, while the diamond shapes symbolize seeds and germination.',
                source_id=s7.id,
                audio_url=None,
                animation_type='glow'
            ),
            models.ARHotspot(
                ar_experience_id=ar_warli.id,
                name='Sacred Tree of Life & Forest Fauna',
                x=78.0,
                y=30.0,
                content='Stylized branching trees shelter peacocks, monkeys, squirrels, and birds, connecting subterranean earth with the celestial sky.',
                cultural_context='Warli culture avoids chopping living trees unnecessarily; trees like the Mahua provide food, medicinal flowers, and sacred wine in symbiotic balance.',
                regional_perspective='Reflects the sacred groves (Devrai) protected by indigenous clans across the Sahyadri range.',
                source_id=s7.id,
                audio_url=None,
            ...
            models.ARHotspot(
                ar_experience_id=ar_warli.id,
                name='Agricultural Cultivation & Grain Pounding',
                x=50.0,
                y=82.0,
                content='Scenes of farmers plowing with bullocks, women pounding paddy with wooden pestles, and carrying bundles of monsoon crops.',
                cultural_context='Reflects daily subsistence rooted in the monsoon cycle (Kharif paddy). Labor is shared communally without social stratification.',
                regional_perspective='Documented in GI Registry application 342 as an authentic core motif of traditional Warli rural life.',
                source_id=s8.id,
                audio_url=None,
